...
df = readtable("$(pwd())/Outputs/valueOfLearning/welfaresxi10m1.csv")
...
resA = load("$(pwd())/Outputs/valueOfLearning/resArrayNICE.jld","resArray")
res = resA[1,1,1]
...
# writetable("$(pwd())/Outputs/valueOfLearning/VoLtable.csv",output)
